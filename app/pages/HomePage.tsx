  ...
  <Stack align="center" gap="xl">
    ...
    <Stack gap="xl" maw={800} py={44}>
      ...
      <Text size="xl" c="primary">
        Whether you have a solid project idea or are feeling lost, we guarantee
        that you will launch a project you can be proud of over the course of 3
        sessions. As a bonus, you&apos;ll find community in the people who
        you&apos;re working alongside with.
      </Text>
    </Stack>
    ...
    <Stack gap="xl" w="100%" maw={800} py={44}>
      ...
      >
        ...
        <Accordion.Item value="attendance">
          <Accordion.Control>Do I need to attend everything?</Accordion.Control>
          <Accordion.Panel>
            <Stack>
              <Text inherit>
        ...
        <Accordion.Item value="not-a-hackathon">
          ...
          <Accordion.Panel>
            ...
            you to provide direct support as you build something that others get
            to experience in the real world. And, instead of a competition, you
            will form a community with those building alongside you.
          </Accordion.Panel>
        </Accordion.Item>
        <Accordion.Item value="experience">
          <Accordion.Control>Do I need prior experience?</Accordion.Control>
          <Accordion.Panel>
            No experience required. LaunchWeek is designed for anyone who wants
            to create things but has been putting off their projects for far too
            long. We strongly believe that you can make A LOT happen in 1 week
        ...
        <Accordion.Item value="fees">
          ...
          <Accordion.Panel>
            ...
            shared vision to help students with a vision to create something of
            their own. We will not charge you at any point for any component of
            the program.
          </Accordion.Panel>
        </Accordion.Item>
        <Accordion.Item value="sessions">
          ...
          <Accordion.Panel>
            Each session begins with one of the hosts briefly sharing their most
            valuable insights from their experience at this stage of
            project-building. Then, instructions will provided from the
            curriculum we&apos;ve designed based on the highly-successful
            programs we&apos;ve attended. The bulk of the remaining time will be
            dedicated to you working on your project with guidance from our
